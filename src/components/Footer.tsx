  ...
  return (
    <footer className="relative w-full py-32 flex flex-col items-center justify-center bg-[#050505] border-t border-zinc-900 z-10 overflow-hidden">
      ...
      <div className="text-center px-6 max-w-3xl">
        <h2 className="font-black text-4xl md:text-5xl text-[#e0e0e0] mb-8 drop-shadow-[0_0_10px_rgba(255,255,255,0.1)]">
        ...
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="font-light text-white text-sm tracking-[0.3em]">
            FEITO COM 🤍 PARA A ANA CAROLINNE, ISSO É APENAS O COMECO. TE AMO
          </p>
        </div>
      </div>
    </footer>
