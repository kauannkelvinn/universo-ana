...
const locaisDoMapa: LocalMapa[] = [
  {
    ...
    midia: "https://xcvpkzhmpeytdubs.public.blob.vercel-storage.com/gameplay3.mp4",
    tipo: "video",
    formato: "paisagem",
  },
  {
    ...
    midia: "https://xcvpkzhmpeytdubs.public.blob.vercel-storage.com/nossafotoo.jpg",
    tipo: "imagem",
    formato: "paisagem"
  },
  {
    ...
    midia: "https://xcvpkzhmpeytdubs.public.blob.vercel-storage.com/fotoposandoo.jpg",
    tipo: "imagem",
    formato: "retrato"
  },
  {
    ...
    midia: "https://xcvpkzhmpeytdubs.public.blob.vercel-storage.com/dancando.mp4",
    tipo: "video",
    formato: "retrato"
  },
  {
    ...
    midia: "https://xcvpkzhmpeytdubs.public.blob.vercel-storage.com/gameplay4.mp4",
    tipo: "video",
    formato: "paisagem"
  },
  {
    ...
    midia: "https://xcvpkzhmpeytdubs.public.blob.vercel-storage.com/gameplay2.mp4",
    tipo: "video",
    formato: "retrato"
  },
];
        ...
        <AnimatePresence>
          {localAtivo && (
            <motion.div
              ...
              className={`absolute bg-[#12233a] border-b-4 border-black/50 rounded-3xl z-30 flex flex-col overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.8)] ring-2 ring-blue-900/50 ${localAtivo.formato === "retrato"
